namespace NWN.Events {
	public class InventoryEvent : NWNXEvent {
		...
		public InventoryEvent(string script) {
			EventType = script;
		}
		...
		public static void EventHandler(string script) {
			...
			switch (script) {
				case BEFORE_INVENTORY_ADD_ITEM:
					BeforeAddItem(e);
					break;
				case AFTER_INVENTORY_ADD_ITEM:
					AfterAddItem(e);
					break;
				case BEFORE_INVENTORY_REMOVE_ITEM:
					BeforeRemoveItem(e);
					break;
				case AFTER_INVENTORY_REMOVE_ITEM:
					AfterRemoveItem(e);
					break;
			}
		}
	...
	public class InventoryOpenEvent : NWNXEvent {
		...
		public InventoryOpenEvent(string script) {
			EventType = script;
		}
		...
		public static void EventHandler(string script) {
			...
			switch (script) {
				case BEFORE_INVENTORY_OPEN:
					BeforeInventoryOpen(e);
					break;
				case AFTER_INVENTORY_OPEN:
					AfterInventoryOpen(e);
					break;
			}
		}
	}
	...
	public class InventorySelectPanelEvent : NWNXEvent {
		...
		public InventorySelectPanelEvent(string script) {
			EventType = script;
		}
		...
		public static void EventHandler(string script) {
			...
			switch (script) {
				case BEFORE_INVENTORY_SELECT_PANEL:
					BeforeSelectPanel(e);
					break;
				case AFTER_INVENTORY_SELECT_PANEL:
					AfterSelectPanel(e);
					break;
			}
		}
