...
namespace NWN.NWNX
{
    public static class Skillranks
    {
        ...
        public static int GetSkillFeatCountForSkill(NWN.Feat feat)
        {
        ...
        public static SkillFeat GetSkillFeatForSkillByIndex(NWN.Feat feat, NWN.Skill skill)
        {
        ...
        public static SkillFeat GetSkillFeat(NWN.Feat feat, NWN.Skill skill)
        {
        ...
        public static void SetSkillFeat(SkillFeat skillFeat, bool createIfNonExistent = false)
        {
            ...
            Internal.NativeFunctions.nwnxPushString(skillFeat.classes.Substring(skillFeat.classes.Length - skillFeat.classes.IndexOf("1"), skillFeat.classes.Length));
        ...
        public static int GetAreaModifier(NWObject area, NWN.Skill skill)
        {
        ...
        public static void SetAreaModifier(NWObject area, NWN.Skill skill, int modifier)
        {
