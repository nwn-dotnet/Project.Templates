...
namespace NWN.NWNX
{
    public class Player
    {
        ...
        {
            if (NWN.NWScript.GetLocalInt(player, "NWNX_PLAYER_GUI_TIMING_ACTIVE") == 1)
                return;
            ...
            int id = NWN.NWScript.GetLocalInt(player, "NWNX_PLAYER_GUI_TIMING_ID") + 1;
            NWN.NWScript.SetLocalInt(player, "NWNX_PLAYER_GUI_TIMING_ACTIVE", id);
            NWN.NWScript.SetLocalInt(player, "NWNX_PLAYER_GUI_TIMING_ID", id);

            NWN.NWScript.DelayCommand(seconds, () => StopGuiTimingBar(player, script, id));
        }
        ...
        {
            int activeId = NWN.NWScript.GetLocalInt(creature, "NWNX_PLAYER_GUI_TIMING_ACTIVE");
            ...
            NWN.NWScript.DeleteLocalInt(creature, "NWNX_PLAYER_GUI_TIMING_ACTIVE");
            ...
            {
                NWN.NWScript.ExecuteScript(script, creature);
            }
        }
