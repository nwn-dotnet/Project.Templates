...
namespace NWN.NWNX
{
    ...
    public static class Reveal
    {
        ...
        public static void RevealTo(NWObject hiding, NWObject observer, DetectionMethod detection = DetectionMethod.Heard)
        {
        ...
        public static void RevealToParty(NWObject hiding, int reveal, DetectionMethod detection = DetectionMethod.Heard)
        {
