...
namespace NWN.NWNX
{
    ...
    {
        const string PLUGIN_NAME = "NWNX_Chat";
        ...
        public static NWObject GetSender()
        {
            ...
            Internal.NativeFunctions.nwnxCallFunction();
            return UIntToObject.AsObject(Internal.NativeFunctions.nwnxPopObject());
        }
        ...
        public static void SetChatHearingDistance(float distance, NWObject listener = null, ChatChannel channel = ChatChannel.PlayerTalk)
        {
            if(listener == null)
                listener = UIntToObject.AsObject(NWObject.OBJECT_INVALID);
        ...
        public static float GetChatHearingDistance(NWObject listener = null, ChatChannel channel = ChatChannel.PlayerTalk)
        {
            if(listener == null)
                listener = UIntToObject.AsObject(NWObject.OBJECT_INVALID);
