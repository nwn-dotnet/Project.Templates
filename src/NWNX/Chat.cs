...
namespace NWN.NWNX {
  public static class Chat {
    ...
    public static void SetChatHearingDistance(float distance, NWObject? listener = null,
      ChatChannel channel = ChatChannel.PlayerTalk) {
      if (listener == null) listener = NWObjectBase.OBJECT_INVALID.AsObject();
    ...
    public static float GetChatHearingDistance(NWObject? listener = null,
      ChatChannel channel = ChatChannel.PlayerTalk) {
      if (listener == null) listener = NWObjectBase.OBJECT_INVALID.AsObject();
