...
namespace NWN.NWNX
{
    public static class Dialog
    {
        ...
        public static string GetCurrentNodeText(DialogLanguages language = DialogLanguages.English, Gender gender = Gender.Male)
        {
        ...
        public static void End(NWObject player)
        {
