...
namespace NWN.NWNX {
  public static class Visibility {
    ...
    public static VisibilityType GetVisibilityOverride(NWObject player, NWObject target) {
    ...
    public static void SetVisibilityOverride(NWObject player, NWObject target, VisibilityType @override) {
