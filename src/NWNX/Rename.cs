...
namespace NWN.NWNX
{
    public class Rename
    {
        ...
        public static void SetPCNameOverride(NWObject target, string newName, string prefix = "", string suffix = "", NameOverrideType playerNameState = NameOverrideType.Default, NWObject observer = null)
        {
