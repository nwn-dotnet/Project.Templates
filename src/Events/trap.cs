namespace NWN.Events {
  public class TrapEvent : NWNXEvent {
    ...
    public TrapEvent(string script) {
      EventType = script;
    }
    ...
    public static void EventHandler(string script) {
      ...
      switch (script) {
        case BEFORE_TRAP_DISARM:
          BeforeTrapDisarm(e);
          break;
        case AFTER_TRAP_DISARM:
          AfterTrapDisarm(e);
          break;
        case BEFORE_TRAP_EXAMINE:
          BeforeTrapExamine(e);
          break;
        case AFTER_TRAP_EXAMINE:
          AfterTrapExamine(e);
          break;
        case BEFORE_TRAP_FLAG:
          BeforeTrapFlag(e);
          break;
        case AFTER_TRAP_FLAG:
          AfterTrapFlag(e);
          break;
        case BEFORE_TRAP_RECOVER:
          BeforeTrapRecover(e);
          break;
        case AFTER_TRAP_RECOVER:
          AfterTrapRecover(e);
          break;
        case BEFORE_TRAP_SET:
          BeforeTrapSet(e);
          break;
        case AFTER_TRAP_SET:
          AfterTrapSet(e);
