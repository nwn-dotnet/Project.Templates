namespace NWN.Events {
  public class GoldEvent : NWNXEvent {
    ...
    public GoldEvent(string script) {
      EventType = script;
    }
    ...
    public static void EventHandler(string script) {
      ...
      switch (script) {
        case BEFORE_INVENTORY_ADD_GOLD:
          BeforeAddGold(e);
          break;
        case AFTER_INVENTORY_ADD_GOLD:
          AfterAddGold(e);
          break;
        case BEFORE_INVENTORY_REMOVE_GOLD:
          BeforeRemoveGold(e);
          break;
        case AFTER_INVENTORY_REMOVE_GOLD:
          AfterRemoveGold(e);
          break;
      }
    }
