namespace NWN.Events {
  public class DetectionEvent : NWNXEvent {
    ...
    public DetectionEvent(string script) {
      EventType = script;
    }
    ...
    public static void EventHandler(string script) {
      ...
      switch (script) {
        case BEFORE_DO_LISTEN_DETECTION:
          BeforeListen(e);
          break;
        case AFTER_DO_LISTEN_DETECTION:
          AfterListen(e);
          break;
        case BEFORE_DO_SPOT_DETECTION:
          BeforeSpot(e);
          break;
        case AFTER_DO_SPOT_DETECTION:
          AfterSpot(e);
          break;
      }
    }
