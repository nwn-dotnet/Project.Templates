namespace NWN.Events {
    public class PartyEvent : NWNXEvent {
        ...
        public PartyEvent(string script) {
            EventType = script;
        }
        ...
        public static void EventHandler(string script) {
            ...
            switch (script) {
                ...
                case AFTER_LEAVE:
                    ...
                    break;
                case BEFORE_KICK:
                    BeforeKickPartyMember(e);
                    break;
                case AFTER_KICK:
                    AfterKickPartyMember(e);
                    break;
                case BEFORE_NEW_LEADER:
                    BeforeTransferLeadership(e);
                    break;
                case AFTER_NEW_LEADER:
                    AfterTransferLeadership(e);
                    break;
            }
        }
    }
    ...
    public class PvPAttitudeEvent : NWNXEvent {
        ...
        public PvPAttitudeEvent(string script) {
            EventType = script;
        }
        ...
        public static void EventHandler(string script) {
            ...
            switch (script) {
                case BEFORE_PVP_ATTITUDE_CHANGE:
                    BeforeChange(e);
                    break;
                case AFTER_PVP_ATTITUDE_CHANGE:
                    AfterChange(e);
                    break;
            }
        }
